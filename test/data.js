...
exports.normal_test_data = exports.test_case_data = void 0;
exports.test_case_data = [
    [
        {
...
const formatData = (query, category, include, exclude) => ({ query, category, include, exclude });
// [output, input] - parse only
exports.normal_test_data = [
    ...
    [
        ...
        formatData("banana e zucchine", "latte", ["zucchero", "panna", "olio"], ["tartufo"]),
    ],
    [
    ...
    [
        ...
        formatData("panna cotta", "", ["crema", "mascarpone", "olio", "marmellata"], ["latte", "uova", "tartufo"]),
    ],
    ...
    [
        ...
        formatData("spaghetti risottati", "", ["zucchine", "gamberi", "leggermente", "scottati"], []),
    ],
    ...
    [
        ...
        formatData("ishwak", // Test case when adding user
        "", ["pesto", "panna", "tartufo", "gamberi", "rossi", "zucchine"], ["basilico", "formaggio"]),
    ],
    [
